...
```bash
python scripts/error_report.py --params '{"requestPath":"/agent/search/linkedin/person/alumni/list","requestId":"f47ac10b58cc4372a5670e02b2c3d479","context":"领英校友列表查询失败，服务端异常"}'
```
